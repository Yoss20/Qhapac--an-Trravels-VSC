      ...
      <div class="contenedorprom fondo">
        ...
        <div class="contro">
          ...
          <div class="vistas-previas">
            <!-- Vista previa 1 -->
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom1" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
              >Reservar</button>
            ...
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom2" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
                >Reservar</button>
              <footer style="margin-bottom: 15px; margin-top: 15px">
                <ul style="color: white">
            ...
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom3" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
                >Reservar</button>
              <footer style="margin-bottom: 15px; margin-top: 15px">
                <ul style="color: white">
            ...
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom4" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
                >Reservar</button>
              <footer style="margin-bottom: 15px; margin-top: 15px">
                <ul style="color: white">
            ...
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom5" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
                >Reservar</button>
              <footer style="margin-bottom: 15px; margin-top: 15px">
                <ul style="color: white">
                  <li><a>7 dias </a></li>
            ...
            <form class="vistaprev" action="Promociones/ReservaPromoPeruano.php" method="POST">
              ...
              <button type="submit" name="btnreservaprom6" class="letraCont Reserva botreserv idlogue" formaction="../VistasPagina/ReservaPromoperuano.php"
                >Reservar</button>
              <footer style="margin-bottom: 15px; margin-top: 15px">
                <ul style="color: white">
                  <li><a>7 dias</a></li>
    ...
    <footer id="mi-footer">
      ...
      <div class="copyright">
        ...
        <div class="footer-links">
          <a href="promocionesUser.php">Inicio</a> |
