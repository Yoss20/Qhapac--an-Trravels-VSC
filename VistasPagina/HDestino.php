...
<nav class="menu">
      ...
      <ul class="menu__links">
         <li class="menu__item">
          ...
          header('Location: ../VistasPagina/HDestino.php');
          exit; 
        }
        ?>
         ...
         <li class="menu__item">
             <form method="post">
            <button type="submit" name="reserva" class="btn1">DestReservainos</button>
        </form>
          </li>
          <?php
          
          if (isset($_POST['reserva'])) {
          header('Location: ../VistasPagina/Vuelo.php');
          exit; 
        }
        ?>
...
<ul class="menu__links">
         <li class="menu__item">
          ...
          header('Location: ../VistasPagina/promociones.php');
          exit; 
        }
        ?>
