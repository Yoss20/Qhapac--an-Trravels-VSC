    ...
    <nav class="menu">
      ...
      <section class="menu_cont">
        ...
        <ul class="menu__links">
          ...
          <li class="menu__item">
            <a href="VistasPagina/VueloUser.php" class="menu__link">Reserva</a>
          </li>
...
<!--Buscar vuelos solo IDA -->
          <form class="flex_SOLOIDA" id="flex_SOLOIDA" action="VistasPagina/Vuelo.php" method="POST">
            ...
            <div class="btnIda">
              <button type="submit" name="submit1" class="btnI" formaction="VistasPagina/VueloUser.php"><img src="assets/lupa.svg" class="lupa"/>Buscar</button>
            </div>
          </form>
...
<!--Buscar vuelos IDA y REGRESO-->
          <form class="flex_IDAYVUELTA" id="flex_IDAYVUELTA" action="VistasPagina/VueloUser.php" method="POST">
          ...
          <div class="flex_cont flex_cont33">
            ...
            <div class="btnIdayVuelta"> 
              <button type="submit" name="submit2" id="submit2" class="btnIV" formaction="VistasPagina/VueloUser.php"><img src="assets/lupa.svg" class="lupa" />Buscar</button>
            </div>
